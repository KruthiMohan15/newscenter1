 ...
 */
package com.indiatoday.newscenter.core.models;
...
import com.indiatoday.newscenter.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "newscenter/components/helloworld");
